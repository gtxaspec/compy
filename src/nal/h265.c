...
Compy_H265NalHeader
Compy_H265NalHeader_parse(uint8_t bytes[restrict static 2]) {
    return (Compy_H265NalHeader){
...
bool Compy_H265NalHeader_is_vps(Compy_H265NalHeader self) {
    return COMPY_H265_NAL_UNIT_VPS_NUT == self.unit_type;
}

bool Compy_H265NalHeader_is_sps(Compy_H265NalHeader self) {
    return COMPY_H265_NAL_UNIT_SPS_NUT == self.unit_type;
}

bool Compy_H265NalHeader_is_pps(Compy_H265NalHeader self) {
    return COMPY_H265_NAL_UNIT_PPS_NUT == self.unit_type;
}
